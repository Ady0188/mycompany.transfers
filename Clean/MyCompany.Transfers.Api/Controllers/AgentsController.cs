...
public sealed class AgentsController : BaseController
{
    ...
    {
        var cmd = new CreateAgentCommand(dto.Id, dto.Account, dto.Name, dto.TimeZoneId, dto.SettingsJson, dto.PartnerEmail);
    ...
    {
        var cmd = new UpdateAgentCommand(id, dto.Account, dto.Name, dto.TimeZoneId, dto.SettingsJson, dto.PartnerEmail);
        var result = await _mediator.Send(cmd, ct);
