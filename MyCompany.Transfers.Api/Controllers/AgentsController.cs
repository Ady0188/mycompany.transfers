...
public sealed class AgentsController : BaseController
{
    ...
    {
        var cmd = new CreateAgentCommand(dto.Id, dto.Name, dto.TimeZoneId, dto.SettingsJson, dto.PartnerEmail, dto.Locale ?? "ru");
    ...
    {
        var cmd = new UpdateAgentCommand(id, dto.Name, dto.TimeZoneId, dto.SettingsJson, dto.PartnerEmail, dto.Locale);
        var result = await _mediator.Send(cmd, ct);
